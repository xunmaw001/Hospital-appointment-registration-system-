      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in chuzhenxinxiRecommend" v-bind:key="index">
                <a target="_self" :href="'../chuzhenxinxi/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.zhaopian?item.zhaopian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
