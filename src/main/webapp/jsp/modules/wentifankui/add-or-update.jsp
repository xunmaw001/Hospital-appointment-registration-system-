		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑问题反馈</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑问题反馈</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">问题反馈信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>问题反馈</label>
										<input id="wentifankui" name="wentifankui" class="form-control" placeholder="问题反馈">
									</div>
									<div class="form-group col-md-6">
										<label>反馈时间</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "wentifankui/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("wentifankui/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function dataBind(){
			...
			$("#wentifankui").val(ruleForm.wentifankui);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.wentifankui != null && res.data.wentifankui != ''){

					$("#wentifankui").val(res.data.wentifankui);
					}
