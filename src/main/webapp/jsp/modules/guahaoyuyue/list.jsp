...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">挂号预约管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>挂号预约管理</span></li>
								<li class="breadcrumb-item active"><span>挂号预约列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">挂号预约列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
            ...
            crossBtn1.innerHTML = "提问"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"wentifankui\")");
			if(crossBtnControl('提问') == true){
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("guahaoyuyue/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("guahaoyuyue/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("guahaoyuyue/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"guahaoyuyue");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"guahaoyuyue");
