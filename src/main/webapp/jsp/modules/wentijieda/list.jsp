...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">问题解答管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>问题解答列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">问题解答列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>问题解答</th>
											<th onclick="sort('jiedashijian')">解答时间<i id="jiedashijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var wentijiedaCell  = document.createElement('td');

						  if(item.wentijieda != null && item.wentijieda != "" && item.wentijieda.length >= 11){
			  	wentijiedaCell.innerHTML = item.wentijieda.substring(0, 10) + "..."; 
			  }else{
			  	wentijiedaCell.innerHTML = item.wentijieda;
			  }


			row.appendChild(wentijiedaCell);
			var jiedashijianCell  = document.createElement('td');

						  jiedashijianCell.innerHTML = item.jiedashijian;


			row.appendChild(jiedashijianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("wentijieda/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"wentijieda");
