		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑问题解答</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>问题解答管理</span></li>
								<li class="breadcrumb-item active"><span>编辑问题解答</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">问题解答信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>问题解答</label>
										<textarea name="wentijieda" class="form-control" id="wentijieda" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>解答时间</label>
										<div id="jiedashijianDate" class="input-append date form_datetime">
											<input id="jiedashijian-input" name="jiedashijian" size="20" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "wentijieda/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("wentijieda/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("wentijieda/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#jiedashijianDate").datetimepicker({ 
				autoclose: true,
		...
		function dataBind(){
			...
			$("#wentijieda").val(ruleForm.wentijieda);
			$("#jiedashijian-input").val(ruleForm.jiedashijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.wentijieda != null && res.data.wentijieda != ''){

					$("#wentijieda").val(res.data.wentijieda);
					}
					if(res.data != null && res.data != '' && res.data.jiedashijian != null && res.data.jiedashijian != ''){

					$("#jiedashijian-input").val(res.data.jiedashijian);
					$('#jiedashijianFileName').val(res.data.jiedashijian)
					}
